...
Polyglot monorepo: Next.js 15 web app and Python FastAPI microservices.
Designed for LLM-first development with GitHub Copilot, Cursor, and Claude Code.
...
pnpm turbo run build --filter=@mono/web
```
...
Use the Copilot agent: `@scaffold-service`
...
Use the Copilot agent: `@scaffold-package`
...
| Tooling | Turborepo 2, pnpm 9, uv, Docker Compose, GitHub Actions |
